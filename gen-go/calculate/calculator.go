...
type Calculator interface {
	...
	//  - Arg1
	//  - Arg2
	Calculate(operation Operation, arg1 float64, arg2 float64) (r float64, err error)
}
...
//  - Arg1
//  - Arg2
func (p *CalculatorClient) Calculate(operation Operation, arg1 float64, arg2 float64) (r float64, err error) {
	if err = p.sendCalculate(operation, arg1, arg2); err != nil {
		return
	}
	return p.recvCalculate()
}

func (p *CalculatorClient) sendCalculate(operation Operation, arg1 float64, arg2 float64) (err error) {
...
func (p *CalculatorClient) recvCalculate() (value float64, err error) {
...
func NewCalculatorProcessor(handler Calculator) *CalculatorProcessor {
	...
	self2.processorMap["calculate"] = &calculatorProcessorCalculate{handler: handler}
	return self2
}
...
func (p *calculatorProcessorCalculate) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	var retval float64
	var err2 error
	if retval, err2 = p.handler.Calculate(args.Operation, args.Arg1, args.Arg2); err2 != nil {
...
type CalculatorCalculateArgs struct {
	Operation Operation `thrift:"operation,1" json:"operation"`
	Arg1      float64   `thrift:"arg1,2" json:"arg1"`
	Arg2      float64   `thrift:"arg2,3" json:"arg2"`
}
...
func (p *CalculatorCalculateArgs) GetOperation() Operation {
	return p.Operation
}

func (p *CalculatorCalculateArgs) GetArg1() float64 {
	return p.Arg1
}

func (p *CalculatorCalculateArgs) GetArg2() float64 {
	return p.Arg2
}
...
func (p *CalculatorCalculateArgs) readField3(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadDouble(); err != nil {
...
func (p *CalculatorCalculateArgs) writeField2(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("arg1", thrift.DOUBLE, 2); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:arg1: ", p), err)
	}
	if err := oprot.WriteDouble(float64(p.Arg1)); err != nil {
...
func (p *CalculatorCalculateArgs) writeField3(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("arg2", thrift.DOUBLE, 3); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:arg2: ", p), err)
	}
	if err := oprot.WriteDouble(float64(p.Arg2)); err != nil {
...
var CalculatorCalculateResult_Success_DEFAULT float64

func (p *CalculatorCalculateResult) GetSuccess() float64 {
	if !p.IsSetSuccess() {
